...
async function main() {
  ...
  var data = fs.readFileSync("../BusinessLogic-benchmarks/workload/scripts/setTrainersData.json");
  ...
  for (let i = 0; i < numTransactions ; i++) {
    let adr =data[i].trainer
    var tx = await contract.registerTrainer(adr);
