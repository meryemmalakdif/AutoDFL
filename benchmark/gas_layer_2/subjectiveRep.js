...
async function main() {
  ...
  var data = fs.readFileSync("../ReputationModel-benchmarks/workload/scripts/subj/necessaryDataFiles/SubjData.json");
  ...
  for (let i = 0; i < numTransactions ; i++) {
    let taskId = data[i].task ; 
    let trainer = data[i].adr ; 
    console.log(trainer);
    console.log(taskId);


    var tx = await contract.calculateSubjectiveReputation(taskId,trainer);
