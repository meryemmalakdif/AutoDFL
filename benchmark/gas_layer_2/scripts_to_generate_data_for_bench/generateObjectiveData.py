...
def get_data(item):
    ...
    scores = [random.randint(100000000000000000, 650000000000000000) for _ in range(3)]
...
with open('setTaskTrainersData.json', 'r') as input_file:
...
with open('objectiveReputationData.json', 'w') as output_file:
