...
class StoreWorkload extends WorkloadModuleBase {
    ...
    _generateWorkload() {
        ...
        for(let i= 0; i < this.roundArguments.txnPerBatch; i++) {
            ...
            let address = {address:'0xf17f52151EbEF6C7334FAD080c5704D77216b732'};
            let amount = data[0][this.txIndex+roundIndexes[this.roundArguments.num-1]].amount; 
            let args = {
                contract :this.roundArguments.contract,
                verb: 'createTask',
                args: [hash,amount,address.address],
                readOnly: false,
            }
