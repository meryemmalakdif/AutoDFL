...
const CONTRACT_ADDRESS = "0x919FD847a2baEfeB9696aCb95c9154f0eC9964D0";
...
async function main() {
  ...
  for (let i = 0; i < numTransactions ; i++) {
    let _modelCID =data[i]._modelCID
    let _infoCID = data[i]._infoCID ; 
    let maxRounds = data[i].maxRounds ; 
    let requiredTrainers = data[i].requiredTrainers ; 
    let requiredAggregators = data[i].requiredAggregators ; 
    var tx = await contract.publishTask(_modelCID, _infoCID, maxRounds, requiredTrainers);
